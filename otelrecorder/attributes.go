...
func (e *Exporter) eventAttributes(entry *recorder.Entry) []attribute.KeyValue {
	...
	if t := entry.Timings; t != nil {
		for _, tv := range []struct {
			...
			{"blocked", t.Blocked}, {"dns", t.DNS}, {"connect", t.Connect},
			{"ssl", t.SSL}, {"send", t.Send}, {"wait", t.Wait}, {"receive", t.Receive},
		} {
...
func (e *Exporter) appendCustom(dst []attribute.KeyValue,
	fn func(*recorder.Entry) []attribute.KeyValue, entry *recorder.Entry) []attribute.KeyValue {
	if fn == nil {
		return dst
	}
	extra := fn(entry)
